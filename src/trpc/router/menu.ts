...
export const menuRouter = router({
  ...
  getMenusForWeek: publicProcedure
    .input(
      z.object({
        locationId: z.string(),
  ...
  searchMenuItems: publicProcedure
    .input(
      z.object({
        locationId: z.string(),
        date: z.string().regex(/^\d{4}-\d{2}-\d{2}$/),
  ...
  getFilteredMenu: publicProcedure
    .input(
      z.object({
        locationId: z.string(),
        date: z.string().regex(/^\d{4}-\d{2}-\d{2}$/),
